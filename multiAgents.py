...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        heuristic = successorGameState.getScore() + (foodScore + capsuleScore)/closestGhost + totalScaredTime
        #print heuristic
        return heuristic
